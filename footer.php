      ...
      <div class="c-footer__links">
        ...
        <div class="c-footer__col">
          ...
          <ul class="c-footer__list c-footer__list--social">
            ...
            <li>
              <a class="c-footer__social" href="https://www.instagram.com/notos.hiroshima/" target="_blank" rel="noopener noreferrer" aria-label="InstagramでNotosをフォローする">
                <span class="c-footer__icon" aria-hidden="true">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a class="c-footer__social" href="https://www.youtube.com/@notos_hiroshima" target="_blank" rel="noopener noreferrer" aria-label="YoutubeでNotosをフォローする">
                <span class="c-footer__icon" aria-hidden="true">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
